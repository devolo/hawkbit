...
public class JpaRolloutManagement implements RolloutManagement {
    ...
    @Override
    public void setRolloutAsCleanedUp(Rollout rollout) {
        Optional<JpaRollout> rolloutRef = rolloutRepository.findById(rollout.getId());
        rolloutRef.get().setIsCleanedUp(true);
    }
