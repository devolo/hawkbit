...
public class SecurityManagedConfiguration {
    ...
    @Bean
    @ConditionalOnMissingBean
    public HttpControllerPreAuthenticatedSecurityHeaderFilter securityHeaderFilter(final DdiSecurityProperties ddiSecurityConfiguration,
            final TenantConfigurationManagement tenantConfigurationManagement, final TenantAware tenantAware,
            final SystemSecurityContext systemSecurityContext, final AuthenticationManager authenticationManager) throws Exception {
    ...
    static class ControllerSecurityConfigurationAdapter extends WebSecurityConfigurerAdapter {
        ...
        protected void configure(final HttpSecurity http) throws Exception {
            ...
            // There is no good way to get our AuthenticationManager to the bean other than overwriting it here
            securityHeaderFilter.setAuthenticationManager(authenticationManager());
