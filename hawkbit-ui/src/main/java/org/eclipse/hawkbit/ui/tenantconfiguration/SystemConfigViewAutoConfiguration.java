...
public class SystemConfigViewAutoConfiguration {
    ...
    /**
     * Default Bean of target search view to set the target search options
     *
     * @param i18n
     *            VaadinMessageSource
     * @param uiProperties
    ...
    @ViewScope
    @Order(value = 5)
    TargetSearchConfigurationView targetSearchConfigurationView(final VaadinMessageSource i18n,
                                                                final UiProperties uiProperties,
                                                      final TenantConfigurationManagement tenantConfigurationManagement) {
        return new TargetSearchConfigurationView(i18n, uiProperties, tenantConfigurationManagement);
    }
