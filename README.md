...
# Eclipse hawkBit™ - Update Server - Fork from devolo GmbH

Eclipse [hawkBit](http://www.eclipse.org/hawkbit/index.html) is a domain independent back end solution for rolling out software updates to constrained edge devices as well as more powerful controllers and gateways connected to IP based networking infrastructure.

This is a fork maintained by [devolo GmbH,](https://www.devolo.com) Germany.
